        ...
        public bool Register(string[] fields)
        {
            using (var dbContext=new ClubMembershipDbContext())
            {
                User user = new User
                {
                    ...
                    BirthDate = DateTime.Parse(fields[(int)FieldConstants.UserRegistrationField.DateOfBirth]),
                    ...
                    AddressCity = fields[(int)FieldConstants.UserRegistrationField.AddressSecondLine],
